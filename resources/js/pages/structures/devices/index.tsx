import StructureDevicesDossier from '@/components/structure/dossier/structure-devices-dossier';
...
function StructureDevicesIndexPage() {
    ...
    return (
        ...
        >
            <CentredLayout>
                <DossierPagelayout>
                    <StructureDevicesDossier structure={structure} />
                </DossierPagelayout>
            </CentredLayout>
        </AppLayout>
    );
...
export default StructureDevicesIndexPage;
