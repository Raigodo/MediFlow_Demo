...
use App\Http\Resources\Medication\Base\MedicationsActionsResource;

class MedicationPreviewPagination extends ResourceCollection
{
    ...
    public function toArray(Request $request): array
    {
        $this->paginator->getCollection()
            ->transform(fn($item)
                => (new MedicationPreviewResource($item))
            );
        ...
        return [
            ...
            'collection'=> [
                'data'=> $paginated["data"],
                'actions'=> new MedicationsActionsResource(),
            ],
