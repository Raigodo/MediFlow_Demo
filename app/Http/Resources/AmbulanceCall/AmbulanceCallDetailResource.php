...
use App\Http\Resources\AmbulanceCall\Base\AmbulanceCallDetail;
use App\Http\Resources\AmbulanceCall\Base\AmbulanceCallActionsResource;

class AmbulanceCallDetailResource extends JsonResource
{
    ...
    {
        return [
            'data'=> new AmbulanceCallDetail($this->ambulance_call),
