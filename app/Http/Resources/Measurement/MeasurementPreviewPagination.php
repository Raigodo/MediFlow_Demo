...
use App\Http\Resources\Measurement\MeasurementPreviewResource;
use App\Http\Resources\Measurement\Base\MeasurementsActionsResource;

class MeasurementPreviewPagination extends ResourceCollection
{
    ...
    public function toArray(Request $request): array
    {
        $this->paginator->getCollection()
            ->transform(fn($item)
                => (new MeasurementPreviewResource($item))
            );
